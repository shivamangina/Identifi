        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
          ...
          <div className="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
            ...
            <section aria-labelledby="details-heading" className="mt-12">
              <div>
                <span className="px-2 py-1 m-1 text-green-800 text-xs font-medium bg-green-100 rounded-full">
                  CRYPTO
                </span>
                <span className="px-2 py-1 m-1 text-green-800 text-xs font-medium bg-indigo-100 rounded-full">
                  TRAVEL
                </span>
                <span className="px-2 py-1 m-1 text-green-800 text-xs font-medium bg-blue-100 rounded-full">
                  VLOGS
                </span>
              </div>
              <br />
